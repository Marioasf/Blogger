	...
	<div class="container">
		...
		<div class="content">
			<div class="row">
				<div class="col-md-4">
					<h5>About Us</h5>
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus ornare magna non mauris luctus condimentum. Pellentesque ut risus ut orci venenatis posuere sollicitudin ac sapien. </p> <p>Pellentesque tristique mi leo, at malesuada urna aliquet ac. Mauris rutrum neque vitae magna hendrerit porttitor vel vel nulla. Suspendisse finibus purus in turpis dignissim, eget egestas metus egestas.</p>
				</div>
		...
		<div class="copyright pull-right">
			Copyright &copy; <script>document.write(new Date().getFullYear())</script> Luís Francisco.
		</div>
	</div>
</footer>
